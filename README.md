...
Automação de análise de preços de combustíveis com Python utilizando dados públicos da ANP.

Este projeto transforma arquivos brutos da ANP em uma base tratada e um relatório analítico em Excel, reduzindo trabalho manual e aumentando a consistência da análise.
...
- quais estados apresentam maior variação de preços
